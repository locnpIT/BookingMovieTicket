        ...
        >
          ...
          <div className="absolute left-8 top-1/2 -translate-y-1/2 text-white">
            ...
            <div className="mt-4 flex gap-3">
              <button className="rounded-lg bg-sky-600 px-4 py-2 text-sm font-medium hover:bg-sky-700">Đặt vé ngay</button>
              <button className="rounded-lg bg-white/20 px-4 py-2 text-sm font-medium hover:bg-white/30">Xem chi tiết</button>
            </div>
          </div>
        </div>
      ))}
      <button onClick={prev} className="absolute left-3 top-1/2 -translate-y-1/2 rounded-full bg-black/40 p-2 text-white hover:bg-black/60">‹</button>
      <button onClick={next} className="absolute right-3 top-1/2 -translate-y-1/2 rounded-full bg-black/40 p-2 text-white hover:bg-black/60">›</button>
